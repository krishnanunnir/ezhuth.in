...
DATABASE_ENGINE = input("DATABASE_ENGINE:\t")  or "django.db.backends.postgresql_psycopg2"
...
export DEBUG=%s
export SECRET_KEY=%s
export DATABASE_ENGINE=%s
export DATABASE_NAME=%s
export DATABASE_USER=%s
export DATABASE_PASSWORD=%s
export DATABASE_HOST=%s \
""" %(ALLOWED_HOSTS, DEBUG, SECRET_KEY, DATABASE_ENGINE, DATABASE_NAME, DATABASE_USER, DATABASE_PASSWORD, DATABASE_HOST)
